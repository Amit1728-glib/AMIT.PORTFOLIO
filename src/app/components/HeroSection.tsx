...
function AvatarGlobe() {
  return (
    <motion.div
      className="
        relative
        w-[clamp(260px,75vw,360px)]
        h-[clamp(260px,75vw,360px)]
        md:w-80
        md:h-80
        lg:w-[360px]
        lg:h-[360px]
    ...
    >
      ...
      >
        <div
          ...
          style={{
            transform: `translate(${parallaxX * 0.3}px, ${
              parallaxY * 0.3
            }px)`,
          }}
        >
        ...
        <div
          ...
          style={{
            transform: `translate(${parallaxX * 0.1}px, ${
              -parallaxY * 0.1
            }px)`,
          }}
        >
        ...
        <div className="flex-1 w-full text-center lg:text-left">
          ...
          >
            ...
            <span
              style={{
                background:
                  "linear-gradient(135deg, #2563EB, #60A5FA, #2563EB)",
          ...
          >
            Crafting premium digital experiences with a passion for bold
            design, immersive interfaces, and pixel-perfect execution.
          </motion.p>
